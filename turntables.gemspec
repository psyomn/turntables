...
Gem::Specification.new do |gem|
  ...
  gem.summary       = 'A dumb experimental, lightweight db version control system for SQLite3'
  gem.description   = 'A dumb experimental, lightweight db version control system for SQLite3'
  gem.license       = 'MIT'
  gem.authors       = ['psyomn']
